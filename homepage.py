...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        Button(root, text = " EASY ", command = self.onclose_easy, font =("Consolas", 15), fg = "black", bg = "#F9DCC4", width=13, height=1).place(x=220,y=65)
        Button(root, text = "MEDIUM", command = self.onclose_intermediate, font =("Consolas", 15), fg = "white", bg= "#CDB4DB", width=13, height=1).place(x=220, y=115)
        Button(root, text = " HARD ", command = self.onclose_hard, font =("Consolas", 15), fg = "white", bg = "#4f7aa8", width=13, height=1).place(x=220,y=165)
