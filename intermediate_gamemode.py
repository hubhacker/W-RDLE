...
class Intermediate(Frame):
    ...
    def create_widgets(self):
        ...
        Label(self.frame, text = "INTERMEDIATE MODE", font=("Consolas", 1), bg = "#FFC8DD").place(relx = 0.5, rely = 0.08, anchor = N) # vivian i will change the color later, i can't rn bc i have no wifi
