...
class Intermediate(Frame):
    ...
    def create_widgets(self):
        ...
        self.letter1.grid(row = 8, column = 0, columnspan = 1)
        self.letter2 = Text(self, width = 100, height = 10, wrap = WORD)
        self.letter2.grid(row = 8, column = 1, columnspan = 1)
        self.letter3 = Text(self, width = 100, height = 10, wrap = WORD)
        self.letter3.grid(row = 8, column = 2, columnspan = 1)
        self.letter4 = Text(self, width = 100, height = 10, wrap = WORD)
        self.letter4.grid(row = 8, column = 3, columnspan = 1)
        self.letter5 = Text(self, width = 100, height = 10, wrap = WORD)
        self.letter5.grid(row = 8, column = 4, columnspan = 1)
