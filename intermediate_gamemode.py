...
class Intermediate(Frame):
    ...
    def create_widgets(self):
        ...
        self.letter1 = Text(self, width = 10, height = 5, wrap = WORD, font = ("Ariel"), bg = )
        self.letter1.grid(row = 5, column = 0, columnspan = 1)
        self.letter2 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter2.grid(row = 5, column = 1, columnspan = 1)
        self.letter3 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter3.grid(row = 5, column = 2, columnspan = 1)
        self.letter4 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter4.grid(row = 5, column = 3, columnspan = 1)
        self.letter5 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter5.grid(row = 5, column = 4, columnspan = 1)


        self.letter6 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter6.grid(row = 11, column = 0, columnspan = 1)
        self.letter7 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter7.grid(row = 11, column = 1, columnspan = 1)
        self.letter8 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter8.grid(row = 11, column = 2, columnspan = 1)
        self.letter9 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter9.grid(row = 11, column = 3, columnspan = 1)
        self.letter10 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter10.grid(row = 11, column = 4, columnspan = 1)


        self.letter11 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter11.grid(row = 17, column = 0, columnspan = 1)
        self.letter12 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter12.grid(row = 17, column = 1, columnspan = 1)
        self.letter13 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter13.grid(row = 17, column = 2, columnspan = 1)
        self.letter14 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter14.grid(row = 17, column = 3, columnspan = 1)
        self.letter15 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter15.grid(row = 17, column = 4, columnspan = 1)

        self.letter16 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter16.grid(row = 23, column = 0, columnspan = 1)
        self.letter17 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter17.grid(row = 23, column = 1, columnspan = 1)
        self.letter18 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter18.grid(row = 23, column = 2, columnspan = 1)
        self.letter19 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter19.grid(row = 23, column = 3, columnspan = 1)
        self.letter20 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter20.grid(row = 23, column = 4, columnspan = 1)

        self.letter21 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter21.grid(row = 29, column = 0, columnspan = 1)
        self.letter22 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter22.grid(row = 29, column = 1, columnspan = 1)
        self.letter23 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter23.grid(row = 29, column = 2, columnspan = 1)
        self.letter24 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
        self.letter24.grid(row = 29, column = 3, columnspan = 1)
        self.letter25 = Text(self, width = 10, height = 5, wrap = WORD, font = (), bg = )
